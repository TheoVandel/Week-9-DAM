...
class(rooms)
# Kongerække task 5
danish_kings_spreadsheet <- read.csv("data/Kongerække-CSV-DAM.csv")
mean(na.rm=TRUE, danish_kings_spreadsheet$End_of_reign - danish_kings_spreadsheet$Start_of_reign)
median(na.rm=TRUE, danish_kings_spreadsheet$End_of_reign - danish_kings_spreadsheet$Start_of_reign)
